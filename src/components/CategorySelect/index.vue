  ...
  <div>
    <el-form :inline="true" :model="form" class="demo-form-inline">
      <el-form-item label="一级分类">
        <el-select v-model="form.category1Id" placeholder="请选择" @change="doneCategory1(form.category1Id)"
          :disabled="show">
          <el-option v-for="cg1 in category1Data" :key="cg1.id" :label="cg1.name" :value="cg1.id"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item label="二级分类">
        <el-select v-model="form.category2Id" placeholder="请选择" @change="doneCategory2(form.category2Id)"
          :disabled="show">
          <el-option v-for="cg2 in category2Data" :key="cg2.id" :label="cg2.name" :value="cg2.id"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item label="三级分类">
        <el-select v-model="form.category3Id" placeholder="请选择" @change="doneCategory3(form.category3Id)"
          :disabled="show">
          <el-option v-for="cg3 in category3Data" :key="cg3.id" :label="cg3.name" :value="cg3.id"></el-option>
        </el-select>
      </el-form-item>
    </el-form>
  </div>
